...
def load_dataset(path):
    ...
    for row in df.iterrows():
        ...
        doc = {
            ...
            'documents_submission_date_start': getattr(series, 'documents_submission_date_start', ''),
            'documents_submission_date_end': getattr(series, 'documents_submission_date_end', ''),
            'documents_submission_time_end': getattr(series, 'documents_submission_time_end', ''),
            'is_urgent': getattr(series, 'is_urgent', ''),
            'competition_results_date': getattr(series, 'competition_results_date', ''),
